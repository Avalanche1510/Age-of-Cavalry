...
# 世界动荡等级初始化
execute unless entity @n[type=armor_stand,tag=record] run bossbar add world_turbulence {text:"世界动荡等级",color:"white"}
execute unless entity @n[type=armor_stand,tag=record] run bossbar set world_turbulence max 1200
execute unless entity @n[type=armor_stand,tag=record] run bossbar set world_turbulence style notched_6
...
execute as @n[type=armor_stand,tag=record] run scoreboard players set @n[type=armor_stand,tag=record] last_stage 0
execute as @n[type=armor_stand,tag=record] run scoreboard players set @n[type=armor_stand,tag=record] villager_count 0
