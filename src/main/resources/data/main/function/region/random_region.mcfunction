...
execute if entity @n[type=villager,tag=!recorded_villager,distance=..192] run execute as @e[type=villager,tag=!recorded_villager,distance=..192] run scoreboard players add @n[tag=record,type=armor_stand] villager_count 1
execute if entity @n[type=villager,tag=!recorded_villager,distance=..192] run execute if score @n[tag=record,type=armor_stand] villager_count matches 6.. run scoreboard players set @s last_region_type 3
scoreboard players set @n[tag=record,type=armor_stand] villager_count 0

execute if score @s last_region_type matches 0 if score @s region_random matches 1..70 run summon marker ~ ~ ~ {Tags:["region_center","neutral"]}
execute if score @s last_region_type matches 0 if score @s region_random matches 71..87 run summon marker ~ ~ ~ {Tags:["region_center","undead_owned"]}
execute if score @s last_region_type matches 0 if score @s region_random matches 88..100 run summon marker ~ ~ ~ {Tags:["region_center","illager_owned"]}

execute if score @s last_region_type matches 1 if score @s region_random matches 1..60 run summon marker ~ ~ ~ {Tags:["region_center","undead_owned"]}
execute if score @s last_region_type matches 1 if score @s region_random matches 61..95 run summon marker ~ ~ ~ {Tags:["region_center","neutral"]}
...
execute if score @s last_region_type matches 2 if score @s region_random matches 1..70 run summon marker ~ ~ ~ {Tags:["region_center","illager_owned"]}
execute if score @s last_region_type matches 2 if score @s region_random matches 71..95 run summon marker ~ ~ ~ {Tags:["region_center","neutral"]}
execute if score @s last_region_type matches 2 if score @s region_random matches 96..100 run summon marker ~ ~ ~ {Tags:["region_center","undead_owned"]}

execute if score @s last_region_type matches 3 run summon marker ~ ~ ~ {Tags:["region_center","villager_owned"]}
execute if score @s last_region_type matches 3 run tag @e[type=villager,tag=!recorded_villager] add recorded_villager
