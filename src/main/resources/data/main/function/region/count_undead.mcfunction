...
spreadplayers ~ ~ 16 96 false @e[type=marker,tag=regional_undead]
# 亡灵将不会生成在玩家附近
execute as @e[type=marker,tag=regional_undead,distance=..192] at @s if entity @p[distance=..16] run kill @s
