...
execute store result score @s[tag=armor,team=!illager_party,team=!villager_party,tag=!captain,tag=!battle_unit] itemRandom run random value 1..200
execute store result score @s[tag=armor,team=!illager_party,team=!villager_party,tag=!captain,tag=!battle_unit] height run data get entity @s Pos[1] 1
