...
execute store result score @s[tag=armor,team=!illager_party,tag=!captain,tag=!cavalry] itemRandom run random value 1..100
...
execute at @s if score @s[tag=armor,tag=!collecter] itemRandom matches 1..5 run tag @s add captain 
