...
execute at @s if entity @n[type=marker,tag=region_center,tag=neutral,distance=..192] run tellraw @s {"text":"发现新区域：中立","color":"green"}
execute at @s if entity @n[type=marker,tag=region_center,tag=undead_owned,distance=..192] run tellraw @s {"text":"发现新区域：被亡灵占领","color":"green"}
execute at @s if entity @n[type=marker,tag=region_center,tag=illager_owned,distance=..192] run tellraw @s {"text":"发现新区域：被灾厄村民占领","color":"green"}
execute at @s if entity @n[type=marker,tag=region_center,tag=villager_owned,distance=..192] run tellraw @s {"text":"发现新区域：被村民占领","color":"green"}
