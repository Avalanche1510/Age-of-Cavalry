...
scoreboard players set @s golem_count 0
# 铁傀儡将不会生成在玩家附近
spreadplayers ~ ~ 4 96 false @e[type=iron_golem,tag=regional_golem]
execute as @e[type=iron_golem,tag=regional_golem,distance=..192] at @s if entity @p[distance=..8] run tp @s ~ -500 ~
