...
tellraw @a {text:"种族与种族之间产生的地缘与资源局部冲突最终演变成了无可挽回的全局灾难。",color:"dark_red"}
tellraw @a {text:"各地不断传来令人不安的简报，各族野外的兵员被紧急召回；",color:"dark_red"}
tellraw @a {text:"在我们尝试缓解局势之前，几乎所有的势力都已经默契地开始无限制扩军。",color:"dark_red"}
