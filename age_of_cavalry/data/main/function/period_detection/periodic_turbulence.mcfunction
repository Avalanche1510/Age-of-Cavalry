...
execute as @n[type=armor_stand,tag=record] if score @s difficulty matches 1 store result score @s trend_rate run random value -1..5
execute as @n[type=armor_stand,tag=record] if score @s difficulty matches 2 store result score @s trend_rate run random value -3..3
execute as @n[type=armor_stand,tag=record] if score @s difficulty matches 3 store result score @s trend_rate run random value -5..1
execute as @n[type=armor_stand,tag=record] if score @s difficulty matches 4 store result score @s trend_rate run random value -7..0
...
execute as @n[type=armor_stand,tag=record] if score @s difficulty matches 6 store result score @s trend_rate run random value 0..4
