...
execute as @e[type=!player,team=undead-arthropod_party] at @s unless score @s isGifted matches -1..1 run function main:gifted_mobs/gifted_level
execute as @e[type=!player,team=piglin_party] at @s unless score @s isGifted matches -1..1 run function main:gifted_mobs/gifted_level
