...
execute as @a if entity @s[level=5..9] run attribute @s minecraft:movement_speed base set 0.110
...
execute as @a if entity @s[level=10..14] run attribute @s minecraft:movement_speed base set 0.115
...
execute as @a if entity @s[level=15..19] run attribute @s minecraft:movement_speed base set 0.120
