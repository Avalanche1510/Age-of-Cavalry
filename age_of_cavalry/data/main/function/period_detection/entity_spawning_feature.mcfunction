...
execute as @e[type=piglin,tag=!has_guard] at @s run function main:squad/reinforced_squad/unit/piglin_unit/piglin_guard
...
execute as @e[type=zombified_piglin,tag=!has_guard] at @s if dimension minecraft:the_nether if score @s GuardRandom matches 1..4 run function main:squad/reinforced_squad/unit/piglin_unit/piglin_guard
